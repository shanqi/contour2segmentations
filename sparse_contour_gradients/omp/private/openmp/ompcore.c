                 ...
                 int T, double eps, int gamma_mode, int profile, double msg_delta, int erroromp)
{
 ...
 /*if (signum==1) printf("selected atom=%d\n",pos);*/
...
if (signum==1) {
    int i1,i2;
    for(i1=0; i1<=i; i1++) {
       for(i2=0; i2<=i; i2++) printf("%f ",Lchol[i2*n+i1]);
       printf("\n");
      }
     } 
*/
